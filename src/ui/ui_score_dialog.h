/********************************************************************************
** Form generated from reading UI file 'score_dialog.ui'
**
...
#ifndef UI_SCORE_DIALOG_H
#define UI_SCORE_DIALOG_H
...
public:
    ...
    void setupUi(QDialog *ScoreDialogClass)
    {
        ...
        ScoreDialogClass->resize(847, 648);
...
""));
        ...
        pushButton_add_row->setMinimumSize(QSize(0, 30));
        ...
        pushButton_remove_row->setMinimumSize(QSize(0, 30));
        ...
        pushButton_confirm->setMinimumSize(QSize(0, 30));
